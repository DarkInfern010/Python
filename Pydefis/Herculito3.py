...
for i in range(len(tab)-1):
    position1 = tab[i].split(",")
    position2 = tab[i+1].split(",")
    if (position1[0] == position2[0]):
        kilometre += abs(int(position1[1]) - int(position2[1]))
    else:
        kilometre += abs(int(position1[0]) - int(position2[0]))
#endfor
